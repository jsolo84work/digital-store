        ...
        <div className="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col w-full max-w-full">
                    ...
                    <div className="flex gap-2 flex-wrap">
                        {sizes.map((size) => (
                            <button
                                ...
                                className={`px-3 py-1 border rounded text-sm sm:text-base ${selectedSize === size
                    ...
                    <div className="flex gap-2 flex-wrap">
                        {colors.map((color) => (
                            <button
                                ...
                                className={`px-3 py-1 border rounded text-sm sm:text-base ${selectedColor === color
                                        ? 'bg-pink-600 text-white border-pink-600'
                                        : 'bg-white text-gray-700 border-gray-300 hover:border-pink-400'
                                    }`}
                            >
                ...
                <button
                    ...
                    className={`w-full text-center font-semibold text-white py-3 rounded-md transition-colors text-sm sm:text-base ${added ? 'bg-green-600 hover:bg-green-700' : 'bg-pink-700 hover:bg-pink-800'
                        }`}
                >
